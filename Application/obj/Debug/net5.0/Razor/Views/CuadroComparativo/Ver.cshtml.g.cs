#pragma checksum "C:\Users\Edson\Downloads\asd123\LOGANTA\Application\Views\CuadroComparativo\Ver.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3cda5330770729fa026de66c96dc3eb0d12c8bfc"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_CuadroComparativo_Ver), @"mvc.1.0.view", @"/Views/CuadroComparativo/Ver.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3cda5330770729fa026de66c96dc3eb0d12c8bfc", @"/Views/CuadroComparativo/Ver.cshtml")]
    ...
    public class Views_CuadroComparativo_Ver : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            WriteLiteral("<div class=\"container w-100 text-center h1 mb-3\">Cuadro Comparativo de Cotizaciones</div>\r\n<table class=\"table table-hover\">\r\n    <thead id=\"tablahead\"></thead>\r\n    <tbody id=\"tablabody\"></tbody>\r\n</table>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3cda5330770729fa026de66c96dc3eb0d12c8bfc3710", async() => {
            }
            );
...
<script>
     ...
     *
     */
    function obtenerItemsCo");
            WriteLiteral(@"nSusCotizaciones() {
    ...
    function mostrarHead() {
        ...
        for (let i = 0; i < jsonProveedoresCotizados.lengt");
            WriteLiteral(@"h; i++) {
            let columnaHead = document.createElement('th');
    ...
    function mostrarBody() {
        for (let i = 0; i < jsonItemsConSusCotizaciones.length; i++) {
            ...
            for (let j = 0; j < jsonItemsConSusCotizaciones[i].listaDeProveedoresCotizados.length;j++) {
                ...
                columnaBody.appendChild(docum");
            WriteLiteral("ent.createTextNode(jsonItemsConSusCotizaciones[i].listaDeProveedoresCotizados[j].ipPrecio));\r\n                filaBody.appendChild(columnaBody);\r\n            }\r\n            tablaBody.appendChild(filaBody);\r\n        }\r\n    }\r\n</script>\r\n");
        }
