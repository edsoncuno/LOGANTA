#pragma checksum "C:\Users\Edson\Downloads\asd123\LOGANTA\Application\Views\Pedido\MostrarAprobadoPorElSolicitante.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bf87a46bf66ff487190490952917e0c2e6a84e64"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bf87a46bf66ff487190490952917e0c2e6a84e64", @"/Views/Pedido/MostrarAprobadoPorElSolicitante.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "bf87a46bf66ff487190490952917e0c2e6a84e647980", async() => {
            }
            );
  ...
  ");
    ...
    function cambiarEstadoDeCantidades() {
        if (esEditableLasCantidades == false) {
            ...
            botonEditarCantidad.innerHTML = 'Editar las Can");
            WriteLiteral(@"tidades de los Items';
    ...
    function agregarEventoQueValidaLosInputsConLaClaseInputItemPedidoCantidad() {
        for (let i = 0; i < InputsConLaClaseInputItemPedidoCantidad.length; i++) {
            InputsConLaClaseI");
            WriteLiteral(@"nputItemPedidoCantidad[i].onchange = function () {
  ...
  ");
    ...
    function desaprobar() {
        fetch(""/Pedido/DesaprobarPedidoAprobadoPorElSolicitante/"", {
            ...
            if (respuestaDelControladorConvertidoToJSON.estado == 0) {
                alert(respuestaDelControladorConvertidoToJSON.mensaje);
                window.location.href = respuestaDelControladorConvertidoToJSON.");
            WriteLiteral("newUrl;\r\n            }\r\n            else {\r\n                alert(respuestaDelControladorConvertidoToJSON.mensaje);\r\n            }\r\n        });\r\n    }\r\n</script>");
        }
